...
public class OrdersBuyMarketFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.fragment_orders_buy_market, container, false);

        mEtNum = (EditText) layout.findViewById(R.id.et_order_buy_market);
        layout.findViewById(R.id.iv_order_buy_market_subtraction).setOnClickListener(this);
        layout.findViewById(R.id.iv_order_buy_market_add).setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_order_buy_market_add:
                ...
                break;
            case R.id.iv_order_buy_market_subtraction:
                if (mEtNum.getText().toString().equals("")) {
                    new AlertDialog.Builder(getActivity())
                            .setMessage("手数不能为空")
                            .setPositiveButton("确定", null)
