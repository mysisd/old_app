...
public class TimeShareFragment extends Fragment implements View.OnClickListener {
    private String commodityNo, number, sellPrice, buyPrice,mUserId;

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.fragment_time_share, container, false);
    ...
    private void initWebView(View layout) {
        WebView webView = (WebView) layout.findViewById(R.id.wv_time_share);
        WebSettings settings = webView.getSettings();
        settings.setJavaScriptEnabled(true);
        webView.setWebViewClient(new WebViewClient());
        webView.setWebChromeClient(new WebChromeClient());
        webView.loadUrl("http://xmyttz.com/rx/rx/rx_data1");
    }
